...
<div class="cart-inner">
    <div class="cart-thead clearfix">
    	<!-- 全选框 -->
        <div class="column t-checkbox form"><input data-cart="toggle-cb" name="toggle-checkboxes" id="toggle-checkboxes_up" type="checkbox" checked="" value="" class="checkAll" onclick="allCheck(this);"/><label for="toggle-checkboxes_up">全选</label></div>
        ...
        <div class="ui-ceilinglamp-1" style="width: 988px; height: 49px;"><div class="cart-dibu ui-ceilinglamp-current" style="width: 988px; height: 49px;">
          <div class="control fdibu fdibucurrent">
              <span class="column t-checkbox form">
                  <input data-cart="toggle-cb" name="toggle-checkboxes" id="toggle-checkboxes_down" type="checkbox" checked="" value="" class="jdcheckbox" onclick="allCheck(this);"/>
              ...
              <span class="delete">
                  ...
                  <a href="/cart/deleteAll.html" clstag="clickcart|keycount|xincart|clearcartlink" id="remove-batch">
                          删除选中的商品
                  </a>
              </span>
              <span class="shopping">
